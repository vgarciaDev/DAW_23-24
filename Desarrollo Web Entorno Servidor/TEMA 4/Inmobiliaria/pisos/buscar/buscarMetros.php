...
<body>
    <form action="buscarMetros.php" method="post">
        <label for="min">Metros Mínimos: </label>
        <input type="text" name="min" id="min">
        <label for="max">Metros Máximos: </label>
    ...
    if(isset($_REQUEST["min"]) && isset($_REQUEST["max"])){
        ...
        //QUERY
        $query = "SELECT * FROM pisos WHERE metros BETWEEN '$minimo' AND '$maximo'";
